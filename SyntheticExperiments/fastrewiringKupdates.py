...
rank_by_proxy_add = lambda g, gap, vecs: rank_by(g, gap, vecs, proxy_add_score, "add")
rank_by_proxy_delete = lambda g, gap, vecs: rank_by(g, gap, vecs, proxy_delete_score, "delete")
